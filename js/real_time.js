$(document).ready(function(){
    // -----------------------------------------------------------------------------
        ...
        // $.getJSON('./data/etc_road_link.geojson', function(data) {
        // // console.log(data['features'][0])
        //     $.getJSON("./data/data_small.json", function(data_j){
        //         console.log(data_j)
        ...
        //             var json = JSON.stringify(data['features'][i]);
        //             json = [json]
        ...
        //             // 處理一個站點無法配對的問題
        //             try{      
        //                 var speed = data_j[data['features'][i]["properties"]["StartETagGantryID"]][0]        //交叉查找出車速
        //             }catch(e){
        //                 alert(data['features'][i]["properties"]["StartETagGantryID"])
        //             }
